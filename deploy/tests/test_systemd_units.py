...
class SystemdUnitsTest(unittest.TestCase):
    ...
    def test_verifier_has_static_and_live_surfaces(self):
        ...
        runtime_unit = self.read("eduscope-runtime-config.service")
        self.assertIn("--public-output-root /run/eduscope-public", runtime_unit)
        self.assertIn("ReadWritePaths=/run/eduscope /run/eduscope-public /media/eduscope", runtime_unit)
